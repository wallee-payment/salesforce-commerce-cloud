...
function Handle(basket) {
    return require("~/cartridge/scripts/wallee/processor").handle(basket);
}
...
function Authorize(orderNumber, paymentInstrument) {
    return require("~/cartridge/scripts/wallee/processor").authorize(dw.order.OrderMgr.getOrder(orderNumber), orderNumber, paymentInstrument);
}
