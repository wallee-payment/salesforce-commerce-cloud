    ...
    SubscriptionMetricService.prototype._delete = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > _delete > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > _delete > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionMetricService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionMetricService.prototype.create = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionMetricService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionMetricService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionMetricService.prototype.update = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionMetricService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionMetricService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
