    ...
    ShopifySubscriptionService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.create = function (spaceId, creationRequest, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.terminate = function (spaceId, subscriptionId, respectTerminationPeriod, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > terminate > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > terminate > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.update = function (spaceId, subscription, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifySubscriptionService.prototype.updateAddresses = function (spaceId, updateRequest, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifySubscriptionService > updateAddresses > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifySubscriptionService > updateAddresses > " + error.type + " > " + JSON.stringify(error));
        }
    };
