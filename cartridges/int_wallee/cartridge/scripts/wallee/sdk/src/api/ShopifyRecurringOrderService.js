    ...
    ShopifyRecurringOrderService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifyRecurringOrderService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifyRecurringOrderService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifyRecurringOrderService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifyRecurringOrderService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifyRecurringOrderService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifyRecurringOrderService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifyRecurringOrderService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifyRecurringOrderService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    ShopifyRecurringOrderService.prototype.update = function (spaceId, updateRequest, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > ShopifyRecurringOrderService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > ShopifyRecurringOrderService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
