    ...
    TransactionService.prototype._export = function (spaceId, request, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > _export > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > _export > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.confirm = function (spaceId, transactionModel, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > confirm > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > confirm > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.create = function (spaceId, transaction, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.createTransactionCredentials = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > createTransactionCredentials > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > createTransactionCredentials > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.deleteOneClickTokenWithCredentials = function (credentials, tokenId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > deleteOneClickTokenWithCredentials > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > deleteOneClickTokenWithCredentials > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.fetchOneClickTokensWithCredentials = function (credentials, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > fetchOneClickTokensWithCredentials > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > fetchOneClickTokensWithCredentials > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.getInvoiceDocument = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > getInvoiceDocument > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > getInvoiceDocument > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    *
    ...
    TransactionService.prototype.getLatestTransactionLineItemVersion = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > getLatestTransactionLineItemVersion > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > getLatestTransactionLineItemVersion > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.getPackingSlip = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > getPackingSlip > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > getPackingSlip > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.processOneClickTokenAndRedirectWithCredentials = function (credentials, tokenId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > processOneClickTokenAndRedirectWithCredentials > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > processOneClickTokenAndRedirectWithCredentials > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.processWithoutUserInteraction = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > processWithoutUserInteraction > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > processWithoutUserInteraction > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.readWithCredentials = function (credentials, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > readWithCredentials > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > readWithCredentials > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionService.prototype.update = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
