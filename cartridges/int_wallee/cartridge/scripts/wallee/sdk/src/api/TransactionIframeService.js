    ...
    TransactionIframeService.prototype.javascriptUrl = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionIframeService > javascriptUrl > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionIframeService > javascriptUrl > " + error.type + " > " + JSON.stringify(error));
        }
    };
