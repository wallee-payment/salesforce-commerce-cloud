    ...
    PaymentTerminalService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.link = function (spaceId, terminalId, serialNumber, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > link > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > link > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.triggerFinalBalance = function (spaceId, terminalId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > triggerFinalBalance > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > triggerFinalBalance > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.triggerFinalBalanceByIdentifier = function (spaceId, terminalIdentifier, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > triggerFinalBalanceByIdentifier > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > triggerFinalBalanceByIdentifier > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    PaymentTerminalService.prototype.unlink = function (spaceId, terminalId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > PaymentTerminalService > unlink > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > PaymentTerminalService > unlink > " + error.type + " > " + JSON.stringify(error));
        }
    };
