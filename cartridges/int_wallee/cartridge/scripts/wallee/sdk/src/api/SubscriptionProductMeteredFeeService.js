    ...
    SubscriptionProductMeteredFeeService.prototype._delete = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > _delete > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > _delete > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionProductMeteredFeeService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionProductMeteredFeeService.prototype.create = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionProductMeteredFeeService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionProductMeteredFeeService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    SubscriptionProductMeteredFeeService.prototype.update = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > SubscriptionProductMeteredFeeService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > SubscriptionProductMeteredFeeService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
