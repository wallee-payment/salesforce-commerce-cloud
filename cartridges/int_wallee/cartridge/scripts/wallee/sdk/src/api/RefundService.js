    ...
    RefundService.prototype.count = function (spaceId, filter, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > count > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > count > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.fail = function (spaceId, refundId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > fail > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > fail > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.getRefundDocument = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > getRefundDocument > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > getRefundDocument > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.getRefundDocumentWithTargetMediaType = function (spaceId, id, targetMediaTypeId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > getRefundDocumentWithTargetMediaType > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > getRefundDocumentWithTargetMediaType > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.refund = function (spaceId, refund, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > refund > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > refund > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.search = function (spaceId, query, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > search > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > search > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    RefundService.prototype.succeed = function (spaceId, refundId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > RefundService > succeed > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > RefundService > succeed > " + error.type + " > " + JSON.stringify(error));
        }
    };
