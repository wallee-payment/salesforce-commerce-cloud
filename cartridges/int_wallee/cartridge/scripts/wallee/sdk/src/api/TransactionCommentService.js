    ...
    TransactionCommentService.prototype._delete = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > _delete > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > _delete > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.all = function (spaceId, transactionId, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > all > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > all > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.create = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > create > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > create > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.pin = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > pin > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > pin > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.read = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > read > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > read > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.unpin = function (spaceId, id, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > unpin > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > unpin > " + error.type + " > " + JSON.stringify(error));
        }
    };
    /**
    ...
    TransactionCommentService.prototype.update = function (spaceId, entity, options) {
        ...
        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
            ...
            try {
                ...
                dw.system.Logger.error("wallee > TransactionCommentService > update > unable to parse JSON > " + JSON.stringify({ message: e.message, fileName: e.fileName, lineNumber: e.lineNumber }));
            }
            return body;
        }
        else {
            ...
            throw new Error("wallee > TransactionCommentService > update > " + error.type + " > " + JSON.stringify(error));
        }
    };
