...
var Transaction = /** @class */ (function () {
    ...
    function Transaction(currentBasket) {
        ...
        this.TransactionPaymentPageService = new Wallee.api.TransactionPaymentPageService(this.ApiClient);
    ...
    Transaction.prototype.getPaymentPageUrl = function () {
        ...
        if (transactionId !== null) {
            // let transaction: Wallee.model.Transaction = this.getTransactionById(this.spaceId, transactionId);
